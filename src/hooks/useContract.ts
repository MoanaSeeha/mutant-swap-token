...
import { ChainId, Token, WETH } from '@mutantswap/sdk'
...
import { abi as CLAIM_ABI } from '../constants/abis/claim-mcoin.json'
...
import { AIRDROP_ADDRESS, BRIDGE_MIGRATOR_ADDRESS, MCOIN, USDC, WNEAR, fNEAR, fUSDC, CLAIM_ADDRESS } from '../constants'
